...
export const AUDIT_ACTIONS = {
  ...
  PRICE_LIST_OWNERSHIP_TRANSFERRED: "price_list.ownership_transferred",
  PRICE_LIST_ASSIGNMENT_CREATED: "price_list_assignment.created",
  PRICE_LIST_ASSIGNMENT_UPDATED: "price_list_assignment.updated",
  PRICE_LIST_ASSIGNMENT_ARCHIVED: "price_list_assignment.archived",
  PRICE_LIST_DEFAULT_CHANGED: "price_list_assignment.default_changed",
